...
@UiController("pdischeduler$TaskRun.list")
@UiDescriptor("task-run-list.xml")
@LookupComponent("taskRunsTable")
public class TaskRunList extends StandardLookup<TaskRun> {
    ...
    private void onBeforeShow(BeforeShowEvent event) {
        ...
        getWindow().getFrame().setCaption("Results - " + currProject.getName() + " - " + currTask.getName());
        onRefreshBtnClick();
    }
    ...
    public void onRefreshBtnClick() {
        ...
        taskRunsDl.setParameter("currTaskId", currTask.getId());
        taskRunsDl.load();
