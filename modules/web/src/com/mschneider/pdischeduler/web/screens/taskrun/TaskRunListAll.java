...
@UiController("pdischeduler$TaskRun.listall")
@UiDescriptor("task-run-list-all.xml")
@LookupComponent("taskRunsTable")
public class TaskRunListAll extends StandardLookup<TaskRun> {
    ...
    private void onBeforeShow(BeforeShowEvent event) {
        ...
        getWindow().getFrame().setCaption("Results - ALL");
        onRefreshBtnClick();
    }
    ...
    protected void onInit(InitEvent event) {
        ...
        if (userSession.getTimeZone() != null) {
            userTimeZone = userSession.getTimeZone().getID();
        } else {
    ...
    public Component generateStartTimeField(TaskRun entity) {
        if (entity.getStartTime() != null) {
            String str = TimeZoneUtils.strFromUtcDateConvertToTimezone(entity.getStartTime(), userTimeZone);
    ...
    public Component generateStopTimeField(TaskRun entity) {
        if (entity.getStopTime() != null) {
            String str = TimeZoneUtils.strFromUtcDateConvertToTimezone(entity.getStopTime(), userTimeZone);
            return new Table.PlainTextCell(str);
        }
        return null;
    }
    ...
    private void taskDisplayCall(Task task) {
        TaskDisplay screen = screenBuilders.editor(Task.class, this)
                ...
                .build();
        screen.setCurrProject(task.getProject());
        screen.show();
    }
    ...
    private void setHeadline() {
        headline.setValue("Timezone: " + userTimeZone
                + ", Current Time: " + TimeZoneUtils.dateNowStr(userTimeZone));
    }
